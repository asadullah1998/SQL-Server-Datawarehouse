...
/****** Object:  Job [DailyETLRun]    Script Date: 01-Oct-25 10:13:46 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 01-Oct-25 10:13:46 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Landing Run]    Script Date: 01-Oct-25 10:13:46 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Landing Run', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Staging Run]    Script Date: 01-Oct-25 10:13:46 PM ******/
...
Exec STG.SP_FactInvoice', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DWH Load]    Script Date: 01-Oct-25 10:13:46 PM ******/
